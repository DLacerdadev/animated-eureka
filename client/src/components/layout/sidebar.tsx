    ...
    <>
      ...
      >
        <div className="flex flex-col h-full bg-gradient-to-b from-slate-800 via-slate-900 to-slate-800 shadow-2xl">
          {/* Logo/Header */}
          <div className="relative p-3 bg-gradient-to-r from-slate-900 to-slate-800 border-b border-slate-600/50">
            ...
            <div className="relative flex items-center justify-between">
              ...
              >
                <div className="flex flex-col items-center space-y-1">
                  ...
                  <p className="text-xs text-slate-400 font-medium text-center leading-tight">Dashboard RH Senior</p>
                </div>
              </motion.div>
              <button 
                onClick={onClose}
